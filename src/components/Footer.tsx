    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-wrap justify-center gap-6 text-sm text-gray-400">
          ...
          <a href="https://discord.gg/usmle" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-400 transition-colors inline-flex items-center gap-1.5">
          ...
          <a href="#" className="hover:text-green-400 transition-colors inline-flex items-center gap-1.5" title="WeChat USMLE Group">
          ...
          <a href="https://twitter.com/usmleprep" target="_blank" rel="noopener noreferrer" className="hover:text-sky-400 transition-colors inline-flex items-center gap-1.5">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            X / Twitter
          </a>
          <a href="https://github.com/username/usmle-prep" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors inline-flex items-center gap-1.5">
