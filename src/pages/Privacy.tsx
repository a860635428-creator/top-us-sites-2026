    ...
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">7. AI-Generated Content & Medical Disclaimer</h2>
            <p>Most practice questions and explanations on this platform are generated by artificial intelligence (AI) for educational reference only. While we strive for accuracy, AI-generated content may contain errors, outdated information, or inconsistencies.</p>
            <p className="mt-2"><strong>Important Medical Disclaimer:</strong> The content on this platform is provided for <strong>educational and study reference purposes only</strong>. It does <strong>NOT</strong> constitute medical advice, diagnosis, treatment recommendation, or clinical guidance. You should always consult qualified healthcare professionals for medical decisions and verify study content against official USMLE resources including First Aid, UWorld, and NBME practice exams.</p>
            <p className="mt-2">Users are strongly advised to verify all answers and explanations with official resources. We are not responsible for any inaccuracies in AI-generated content. If you find an error, please report it to <a href="mailto:a860635428@gmail.com" className="text-blue-600 hover:underline">a860635428@gmail.com</a>.</p>
            <p className="mt-2 text-sm text-gray-500">AI 生成内容及医疗免责：本平台大部分练习题和解释由人工智能（AI）生成，仅供学习参考，不构成医疗建议、诊断或治疗推荐。强烈建议用户通过 First Aid、UWorld、NBME 官方练习题等官方资源核实所有答案和解释。发现错误欢迎邮件反馈。</p>
          </section>
